...
export default function Footer() {
  return (
    <footer className="bg-navy-deep text-white" role="contentinfo">
      <div className="max-w-[96rem] mx-auto px-4 sm:px-6 lg:px-20 py-16 sm:py-20 lg:py-24">
        {/* Stack mobile, grid tablet+ */}
            ...
            <ul className="space-y-2.5">
              {links.map(({ label, href }) => (
                <li key={href}>
                  <a
                    href={href}
                    className="text-white/50 hover:text-gold text-sm transition-colors duration-300 py-1.5 inline-block"
                  >
                    {label}
                  </a>
                </li>
            ...
            <div className="flex gap-1">
              {socials.map(({ href, label, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="p-3 text-white/40 hover:text-gold transition-colors duration-300 min-w-[48px] min-h-[48px] flex items-center justify-center"
                >
                  <Icon />
                </a>
              ))}
        ...
        <div className="mt-12 sm:mt-16 pt-8 border-t border-white/[0.06] text-center text-white/20 text-xs tracking-wide">
